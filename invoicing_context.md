...
&nbsp;&nbsp;swissQrCode | hash | swissQrCode; **optional** (when used:  IBAN & ESR fields MUST BE EMPTY or Omitted!); see the [SwissQRCode Section](#minimal-swiss-qr-code-when-creating-an-invoice) at the end of this page
